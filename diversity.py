...
class Similarity:
    ...
    def calculate_weighed_similarities(self, relative_similarities):
        """Calculates weighted sums of similarities to each species.
        ...
        Parameters
        ----------
        relative_similarities: numpy.ndarray
        ...
        return self.weighed_similarities_from_file(relative_similarities)
...
class Metacommunity:
    ...
    def __post_init__(self):
        ...
        self.similarity = Similarity(
            self.abundance, self.similarities_filepath,
            self.similarity_function, self.features)
