...
Species richness (viewpoint = 0), Shannon index (viewpoint = 1), Simpson index (viewpoint = 2), Berger-Parker index (viewpoint = $\infty$), and Hill numbers ($-\infty \le \text{viewpoint} \le \infty$).
